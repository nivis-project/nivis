...
- `banner.png`, `nivis-emblem.svg`, `favicon.svg` — brand assets copied
...
|---|---|---|
| Installing `nivis` | `docs/INSTALL.md` | site `INSTALL.md` (include); tutorial + README link |
...
| EC2 + NixOS tutorial | `docs/TUTORIAL-EC2-NIXOS.md` | site `TUTORIAL-EC2-NIXOS.md` (include) |
